...
```sh
cleos system newaccount -s -j -d --transfer --stake-net "1.000 A" --stake-cpu "1.000 A" --buy-ram-kbytes 50 eosio eosio.wrap EOS8MMUW11TAdTDxqdSwSqJodefSoZbFhcprndomgLi9MeR2o8MT4 > generated_account_creation_trx.json
```
```console
...
726967ms thread-0   main.cpp:429                  create_action        ] result: {"binargs":"0000000000ea305500004d1a03ea3055102700000000000004535953000000001027000000000000045359530000000001"} arg: {"code":"eosio","action":"delegatebw","args":{"from":"eosio","receiver":"eosio.wrap","stake_net_quantity":"1.0000 A","stake_cpu_quantity":"1.0000 A","transfer":true}}
```
```sh
...
net bandwidth:
     staked:          1.0000 A           (total stake delegated from account to self)
     delegated:       0.0000 A           (total staked delegated to account from others)
     used:                 0 bytes
     available:        2.304 MiB  
     limit:            2.304 MiB  
